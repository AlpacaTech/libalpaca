...
bool joystickGetDigital(unsigned char joystick,
 ...
 *
 * PROS_FILE * is the standard library method of referring to a file pointer,
 ...
 *
 * NOTE: The idle task is responsible for freeing the kernel allocated memory
 * from tasks that
 ...
 * static shock
 * or a misbehaving task preventing the timer to be reset. Not recovering from
 * static shock
 * will cause the robot to continue moving its motors indefinitely until turned
 * off manually.
 *
