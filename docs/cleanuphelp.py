...
def parseContent(content):
    ...
    for commit in range(1, len(commits)):
        ...
        for aline in range(aline, len(lines)):
            ...
            if ". M" in lines[aline]:
                if "docs/index.html" not in curline and "docs/log.txt" not in curline and "docs/log.json" not in curline and "bin/" not in curline and "__pycache__" not in curline and "tools/doxygen" not in curline and "tools/PDFs" not in curline and "tools/LATEX" not in curline and not curline.startswith("doxygen"):
                    filesModified.append(curline)
            elif ". A" in lines[aline] and ".swp" not in curline and "bin/" not in curline and "__pycache__" not in curline and "tools/doxygen" not in curline and "tools/PDFs" not in curline and "tools/LATEX" not in curline and not curline.startswith("doxygen"):
                filesAdded.append(curline)
            elif ". D" in lines[aline] and ".swp" not in curline and "bin/" not in curline and "__pycache__" not in curline and "tools/doxygen" not in curline and "tools/PDFs" not in curline and "tools/LATEX" not in curline and not curline.startswith("doxygen"):
